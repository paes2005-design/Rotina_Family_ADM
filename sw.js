const CACHE_NAME='rotina-family-adm-v98-production-20260905.9';
const ROTINA_SW_VERSION='98';
const ROTINA_BUILD_ID='20260905.9';
...
const APP_SHELL=[
  './','./index.html','./index-ADMIN-v9.html','./manifest.json?v=20260905.9',
