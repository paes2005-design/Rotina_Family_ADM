const CACHE_NAME='rotina-family-adm-v92-production-20260905.3';
const ROTINA_SW_VERSION='92';
const ROTINA_BUILD_ID='20260905.3';
...
const APP_SHELL=[
  './','./index.html','./index-ADMIN-v9.html','./manifest.json?v=20260905.3',
  ...
  './sprint2-data-store-v1.js?v=20260905-realtime-rewards-v11',
