const CACHE_NAME='rotina-family-adm-v96-production-20260905.7';
const ROTINA_SW_VERSION='96';
const ROTINA_BUILD_ID='20260905.7';
...
const APP_SHELL=[
  './','./index.html','./index-ADMIN-v9.html','./manifest.json?v=20260905.7',
  ...
  './sprint2-tarefas-realdata-v2.js?v=20260905-series-status-v41',
  './sprint2-participantes-realdata-v1.js',
  './sprint2-recompensas-realdata-v1.js?v=20260905-production-ui-v133',
