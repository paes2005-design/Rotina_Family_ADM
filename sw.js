const CACHE_NAME='rotina-family-adm-v72';
const ROTINA_SW_VERSION='72';
const ROTINA_BUILD_ID='20260830.2';
...
async function respostaComAddons(response){
  ...
  const faltantes=[];
  if(!html.includes('adm-justification-review.js'))faltantes.push('<script type="module" src="./adm-justification-review.js?v=7"><\/script>');
  ...
  if(!html.includes('runtime-build-info.js'))faltantes.push('<script src="./runtime-build-info.js?v=20260830.2"><\/script>');
