const CACHE_NAME='rotina-family-adm-v101-production-20260905.12';
const ROTINA_SW_VERSION='101';
const ROTINA_BUILD_ID='20260905.12';
...
const APP_SHELL=[
  './','./index.html','./index-ADMIN-v9.html','./manifest.json?v=20260905.12',
  ...
  './sprint2-monitor-realdata-v2.js?v=20260909-review-freeze-v35',
