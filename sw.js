const CACHE_NAME='rotina-family-adm-v100-production-20260905.11';
const ROTINA_SW_VERSION='100';
const ROTINA_BUILD_ID='20260905.11';
...
const APP_SHELL=[
  './','./index.html','./index-ADMIN-v9.html','./manifest.json?v=20260905.11',
  ...
  './sprint2-data-store-v1.js?v=20260909-cache-budget-v14',
  './sprint2-tarefas-realdata-v2.js?v=20260905-delete-v43',
  './sprint2-participantes-realdata-v1.js',
  './sprint2-recompensas-realdata-v1.js?v=20260909-production-ui-v136',
  './sprint2-conquistas-realdata-v1.js?v=20260903-deadline-v1',
  './sprint2-monitor-realdata-v2.js?v=20260909-review-latency-v34',
