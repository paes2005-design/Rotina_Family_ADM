const CACHE_NAME='rotina-family-adm-v71';
const ROTINA_SW_VERSION='71';
const ROTINA_BUILD_ID='20260830.1';
...
async function respostaComAddons(response){
  ...
  if(!html.includes('runtime-build-info.js'))faltantes.push('<script src="./runtime-build-info.js?v=20260830.1"><\/script>');
