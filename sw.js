const CACHE_NAME='rotina-family-adm-v70';
const ROTINA_SW_VERSION='70';
const ROTINA_BUILD_ID='20260829.6';
...
async function respostaComAddons(response){
  ...
  const faltantes=[];
  if(!html.includes('adm-justification-review.js'))faltantes.push('<script type="module" src="./adm-justification-review.js?v=6"><\/script>');
  ...
  if(!html.includes('runtime-build-info.js'))faltantes.push('<script src="./runtime-build-info.js?v=20260829.6"><\/script>');
