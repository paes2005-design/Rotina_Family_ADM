const CACHE_NAME='rotina-family-adm-v94-production-20260905.5';
const ROTINA_SW_VERSION='94';
const ROTINA_BUILD_ID='20260905.5';
...
const APP_SHELL=[
  './','./index.html','./index-ADMIN-v9.html','./manifest.json?v=20260905.5',
