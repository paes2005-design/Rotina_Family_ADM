const CACHE_NAME='rotina-family-adm-v61';
const ROTINA_SW_VERSION='61';
const ROTINA_BUILD_ID='20260827.2';
...
async function respostaComAddons(response){
  ...
  if(!html.includes('runtime-build-info.js'))faltantes.push('<script src="./runtime-build-info.js?v=20260827.2"><\/script>');
