...
async function respostaComAddons(response){
  ...
  if(!html.includes('app-monitoring-dashboard.js'))faltantes.push('<script type="module" src="./app-monitoring-dashboard.js?v=3"><\/script>');
  if(!html.includes('admin-master-integrity-fix.js'))faltantes.push('<script src="./admin-master-integrity-fix.js?v=1"><\/script>');
  if(!html.includes('runtime-build-info.js'))faltantes.push('<script src="./runtime-build-info.js?v=20260829.3"><\/script>');
