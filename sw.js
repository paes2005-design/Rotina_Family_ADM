...
async function respostaComAddons(response){
  ...
  if(!html.includes('adm-justification-live-resolver.js'))faltantes.push('<script type="module" src="./adm-justification-live-resolver.js?v=2"><\/script>');
  ...
  if(!html.includes('runtime-build-info.js'))faltantes.push('<script src="./runtime-build-info.js?v=20260830.8"><\/script>');
