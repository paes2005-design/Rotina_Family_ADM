const CACHE_NAME='rotina-family-adm-v78-justification-rollback';
const ROTINA_SW_VERSION='78';
const ROTINA_BUILD_ID='20260831.1';
...
async function respostaComAddons(response){
  ...
  if(!html.includes('runtime-build-info.js'))faltantes.push('<script src="./runtime-build-info.js?v=20260831.1"><\/script>');
