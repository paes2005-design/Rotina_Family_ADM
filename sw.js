const CACHE_NAME='rotina-family-adm-v42';
...
const ADM_ADDONS=['<script type="module" src="./adm-score-history-cards.js?v=2"><\/script>','<script type="module" src="./adm-monitor-history-fix.js?v=3"><\/script>','<script type="module" src="./family-alarm-admin.js?v=6"><\/script>','<script type="module" src="./reward-redemption-notifications.js?v=1"><\/script>'].join('\n');
