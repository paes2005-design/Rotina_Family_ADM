const CACHE_NAME='rotina-family-adm-v66';
const ROTINA_SW_VERSION='66';
const ROTINA_BUILD_ID='20260829.2';
...
async function respostaComAddons(response){
  ...
  if(!html.includes('runtime-build-info.js'))faltantes.push('<script src="./runtime-build-info.js?v=20260829.2"><\/script>');
