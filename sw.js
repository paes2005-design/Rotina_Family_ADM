const CACHE_NAME='rotina-family-adm-v91-production-20260905.2';
const ROTINA_SW_VERSION='91';
const ROTINA_BUILD_ID='20260905.2';
...
const APP_SHELL=[
  './','./index.html','./index-ADMIN-v9.html','./manifest.json?v=20260905.1',
