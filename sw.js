const CACHE_NAME='rotina-family-adm-v36';
...
const ADM_ADDONS=['<script type="module" src="./adm-score-history-cards.js?v=2"><\/script>','<script type="module" src="./adm-monitor-history-fix.js?v=2"><\/script>','<script type="module" src="./family-alarm-admin.js?v=2"><\/script>'].join('\n');
...
async function respostaComAddons(response){
  ...
  if(!html.includes('adm-monitor-history-fix.js'))faltantes.push('<script type="module" src="./adm-monitor-history-fix.js?v=2"><\/script>');
