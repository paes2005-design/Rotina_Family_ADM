...
const ADM_ADDONS=['<script type="module" src="./adm-score-history-cards.js?v=2"><\/script>','<script type="module" src="./adm-monitor-history-fix.js?v=1"><\/script>','<script type="module" src="./family-alarm-admin.js?v=2"><\/script>'].join('\n');
